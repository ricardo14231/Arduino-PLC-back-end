...
function readRoomByIdPavilion(req, res) {
    return new Promise((resolve, reject) => {
        dataBase.connection.
        query('SELECT id_room, name_room, turn_on_air, current_temperature_air, state_cool_air, state_fan_air, temperature_min_air, temperature_max_air, url_device_air ' +
